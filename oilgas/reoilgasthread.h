...
//    void mainwindow_display(int i,int j,int a,int b,int c);
    ...
    void Send_Oilgundata_dg(QString id,QString jyjid,QString jyqid,QString al,QString qls,QString qll,QString yls,QString yll,QString hyqnd,QString hyqwd,QString yz);//发送油枪数据报文
	//isoosi添加
