#ifndef POST_CQYUBEI_H
#define POST_CQYUBEI_H
#include <QtNetwork/QNetworkRequest>
#include <QtNetwork/QNetworkReply>
#include <QtNetwork/QNetworkAccessManager>
#include <QMainWindow>

class post_CQyubei : public QMainWindow
{
	Q_OBJECT
public:
	explicit post_CQyubei(QWidget *parent = 0);
...
private slots:
    ...
    void Send_Warndata(QString id,QString al,QString mb,QString yz,QString ygyl,QString clzznd,
    ...
    void Send_Surroundingsdata(QString id,QString ygyl,QString yzyl,
                         QString xnd,QString hclnd,QString yqwd,QString yqkj);    //发送环境数据报文
...
private:
    ...
    QString XML_Warndata(QString id,QString data,QString al,QString mb,QString yz,QString ygyl,
